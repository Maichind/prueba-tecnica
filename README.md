...
## ⚠️ Nota de accesibilidad

El texto "IMAGE" en los placeholders usa el color `#A6A2A2` según el diseño 
del Figma, lo que genera un warning de contraste en Lighthouse. Esta es una 
decisión intencional para respetar el diseño entregado. En producción, los 
placeholders serían reemplazados por imágenes reales con `alt` descriptivo.
